...
<div class="container">
    <div class="mt-3">
        <h2>
            <strong>Product Information : </strong><b class="text-primary">SKU -
                {{$response['product']['data'][0]['sku']}}</b>
            <a class="goBack float-right mt-2 cp"><b>
                    < Back</b> </a> </h2> <hr>
                        <div class="row">
                            <div class="col-md-4">
                                @if (count($response['product_image']['data'])>0)
                                <img class="w100pc" src="{{$response['product_image']['data'][0]['url_standard']}}"
                                    alt="">
                                @endif
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="mt-2">
                                    ...
                                    <p>Price: <b><?php echo $response['product']['data'][0]['calculated_price'];?></b>
                                        ( <span
                                            class="text-uppercase text-success"><?php echo $response['product']['data'][0]['availability'];?></span>
                                        )
                                    </p>
                                    <p>Condition: <b><?php echo $response['product']['data'][0]['condition'];?></b></p>
                                    <p>Total Views: <b><?php echo $response['product']['data'][0]['view_count'];?></b>
                                    </p>
